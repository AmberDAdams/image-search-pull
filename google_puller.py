...
class Puller():
    def __init__(self, log_level="info"):
        ...
        self.logger.info("Puller instance created.")
    
    def kill(self):
        self.driver.quit()
        self.logger.info("Driver exited, feel free to delete puller instance")
        
    def search(self, search_term):
        self.driver.get(self.base_url + search_term)
        self.logger.info("Images results page for '%s' loaded", search_term)
    ...
    def pull(self, index):
        ...
        self.logger.info("Image pulled from url at %s", url)
    ...
    def get_index_by_size(self, min_width=None, min_height=None,
        ...
        while satisfied == False:
            ...
            if min_width is not None and img_width < min_width:
                ...
                satisfied = True
                self.logger.info("Using image Index #%s, %spx by %spx",
    ...
    def save_pulled(self, save_path):
        ...
        self.logger.info("Image saved to %s", save_path)
